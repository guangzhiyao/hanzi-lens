  ...
  <div class="flex flex-col items-center gap-3">
    ...
    <div class="flex gap-2 items-center">
      <input
        ...
        class="w-36 px-3 py-2 text-lg text-center border-2 border-gray-300 rounded-lg outline-none focus:border-blue-500 transition-colors"
    ...
    <!-- Viewer -->
    <div v-if="currentChar" :key="currentChar" class="flex flex-col items-center gap-2">
      <!-- Error state -->
      <div v-if="loadError" class="w-[200px] h-[200px] flex flex-col items-center justify-center text-center gap-1.5 rounded-xl border-2 border-red-200 bg-red-50 p-3">
      ...
      <div class="flex gap-2">
        <button
          class="px-4 py-1.5 text-sm border border-gray-300 rounded-lg bg-white hover:bg-gray-100 transition-colors disabled:opacity-40"
          :disabled="!!loadError"
          @click="animate"
        >
          ▶ Animate
    ...
    <!-- Empty state -->
    <div v-else class="w-[200px] h-[200px] flex items-center justify-center text-center text-sm text-gray-400 border-2 border-dashed border-gray-300 rounded-xl p-4">
